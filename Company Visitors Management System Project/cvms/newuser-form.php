...
$password=$_POST['password'];
 $query=mysqli_query($con,"insert into tbluser(username,password) value('$username','$password')");

    if ($query) {
    $msg="User Account has been added.";
  }
  else
    {
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Create</strong> New User Account
                                    </div>
...
<div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="password" name="password" placeholder="Create User Password" class="form-control" required="">
